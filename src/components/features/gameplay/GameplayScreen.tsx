...
const GameplayScreen: React.FC<NavigationProps> = ({ onNavigate, activeWorld, onUpdateWorld }) => {
  ...
  // Keyboard page turning navigation (ArrowLeft = previous, ArrowRight = next)
  React.useEffect(() => {
  ...
  return (
    <div className="flex absolute inset-0 w-full h-full bg-[#e6ebf4] dark:bg-[#0b1329] font-sans overflow-hidden">
        ...
        <div className="flex-1 flex flex-col h-full relative z-10 min-w-0">
            ...
            <motion.div
                ...
                animate={{ 
                    ...
                    overflow: areBarsHidden ? 'hidden' : 'visible'
                }}
            ...
            >
                <div className="bg-[#e6ebf4] dark:bg-[#0b1329] border-t border-[#cbd2df]/20 dark:border-[#142042]/10 flex flex-col shadow-[0_-5px_15px_rgba(0,0,0,0.04)] dark:shadow-[0_-5px_15px_rgba(0,0,0,0.25)]">
            ...
            <AnimatePresence>
                {areBarsHidden && (
                    <motion.div 
                        ...
                        className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 flex items-center gap-2 px-3 py-2 bg-[#e6ebf4]/90 dark:bg-[#0b1329]/90 backdrop-blur-md rounded-2xl border border-[#cbd2df]/25 dark:border-[#142042]/40 shadow-xl"
                    >
            ...
            {showMobileSidebar && (
                <>
                    ...
                    <motion.div
                        ...
                        className="lg:relative fixed top-0 right-0 h-full w-[85vw] max-w-[360px] lg:w-[360px] lg:max-w-none shrink-0 bg-[#e6ebf4] dark:bg-[#0b1329] z-40 border-l border-[#cbd2df]/30 dark:border-[#142042]/30 shadow-2xl lg:shadow-none flex flex-col"
                    >
